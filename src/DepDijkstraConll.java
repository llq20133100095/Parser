 ...
 */
public class DepDijkstraConll {

    public static void main(String[] args) throws IOException{
        FileReader dependencies=new FileReader("./data/conll04/conll04_test/test_dependencies.txt");
...
//        BufferedReader bfTag=new BufferedReader(taggedWord);
        ...
        //Read entityFile
        FileReader entityFile=new FileReader("./data/conll04/conll04_test/test_entity_position.txt");
        BufferedReader bfEntityFile=new BufferedReader(entityFile);
        String lineEntity=null;

        //save the shortest path of <e1>entity</e1>.
        FileWriter e1SDP=new FileWriter("./data/conll04/conll04_test/test_e1_SDP.txt");
        //save the shortest path of <e2>entity</e2>.
        FileWriter e2SDP=new FileWriter("./data/conll04/conll04_test/test_e2_SDP.txt");
        //save the shortest path of position id in e1
        FileWriter e1WordPos=new FileWriter("./data/conll04/conll04_test/test_e1_sdp_pos.txt");
        //save the shortest path of position id in e2
        FileWriter e2WordPos=new FileWriter("./data/conll04/conll04_test/test_e2_sdp_pos.txt");
        ...
        while((lineDepen=bfDepen.readLine())!=null && (lineEntity=bfEntityFile.readLine())!=null){
            ...
            for(String x:strDepen){
                ...
                String forewordSp=x.split(", ")[0];
                String backWordSp=x.split(", ")[1];
                String foreWord=forewordSp.substring(forewordSp.indexOf("(")+1);
                String backWord=backWordSp.substring(0,backWordSp.lastIndexOf(")"));

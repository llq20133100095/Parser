...
class ParserDemo {
  ...
  public static void demoAPI(LexicalizedParser lp) {
    ...
    String sent2 = "Bills on ports and immigration were submitted by Senator Brownback, Republican of Kansas.";
    ...
    TreePrint tp = new TreePrint("penn,wordsAndTags");
    tp.printTree(parse);

    TreePrint tp1 = new TreePrint("penn,typedDependencies");
    tp1.printTree(parse);
  }
